...
<script>
    ...
    import {LoanType, LoanStatus} from '~/utils/selectType';
    ...
    export default {
        data() {
            return {
                LoanType,
                LoanStatus,
                tableThead: ['Application ID', 'Customer ID', 'customer id', 'Customer Mobile', 'Customer Name', 'Ktp Number', 'Register Time', 'personal info upload time', 'employment info upload time', 'contact info upload time']
            }
        },
        computed: {
